...
if (indexedDB) {
  ...
  function seleccionadosStorage() {
    ...
    request.onsuccess = (e) => {
      ...
      alertify.alert('Los caracteres de hiragana seleccionados han sido agregados correctamente a tu colección', 
      function(){ location.reload() }).setHeader('FlashCards Kanjis');
